set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wno-register -fpermissive")

set(antigrain_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/antigrain/agg-2.4)
...
#    ${antigrain_SOURCE_DIR}/font_freetype/agg_font_freetype2.cpp
    ${antigrain_SOURCE_DIR}/font_win32_tt/agg_font_win32_tt.cpp
#    ${antigrain_SOURCE_DIR}/myapp/agg2d_demo.cpp
#    ${antigrain_SOURCE_DIR}/myapp/my_demo.cpp
...
#    ${antigrain_SOURCE_DIR}/src/platform/AmigaOS/agg_platform_support.cpp
#    ${antigrain_SOURCE_DIR}/src/platform/BeOS/agg_platform_support.cpp
...
target_link_libraries(antigrain kernel32 user32 gdi32)
include_directories(${antigrain_SOURCE_DIR}/include)
include_directories(${antigrain_SOURCE_DIR}/src)
